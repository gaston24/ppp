...
<button type="button" class="btn btn-primary btn-sm btn-block" onclick="location.href='facturacion/acumulado_mayoristas.php'">Mayoristas</button>
<button type="button" class="btn btn-secondary btn-sm btn-block" onclick="location.href='facturacion/acumulado_franquicias.php'">Franquicias</button>
<button type="button" class="btn btn-primary btn-sm btn-block" onclick="location.href='facturacion/acumulado_locales.php'">Locales Propios</button>
...
SELECT * FROM SJ_FACTURACION_PPP_DIARIA ORDER BY 1
";
