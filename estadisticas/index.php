...
FROM SJ_BI_MES A
WHERE LEFT(MES, 4) LIKE DATEPART(YEAR, GETDATE())
GROUP BY MES
ORDER BY 1
...
<div class="row">
	...
	<div class="col-4" role="group" aria-label="Basic example" >
		<button type="button" class="btn btn-primary" onclick="location.href='historial/historial_index.php?anio=2016'">2016</button>
		<button type="button" class="btn btn-secondary" onclick="location.href='historial/historial_index.php?anio=2017'">2017</button>
		<button type="button" class="btn btn-primary" onclick="location.href='historial/historial_index.php?anio=2018'">2018</button>
		<button type="button" class="btn btn-secondary" onclick="location.href='historial/historial_index.php?anio=2019'">2019</button>
	</div>
	<div class="col-3">
	</div>
</div>
