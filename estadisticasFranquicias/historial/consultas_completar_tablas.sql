--1
SELECT * INTO SJ_BI_MES_HISTORIAL_ANIOS_ANTERIORES FROM
(
...
WHERE CAST(MES AS VARCHAR) NOT LIKE '2018%'
GROUP BY MES
)A
ORDER BY 1
...
--2
SELECT * INTO SJ_BI_MES_HISTORIAL_ANIOS_ANTERIORES_LOCALES FROM
(
...
SELECT * INTO SJ_BI_MES_HISTORIAL_SEM_ANTERIORES_LOCALES FROM
(
	SELECT * FROM
	(
		SELECT 
...
SELECT * INTO SJ_BI_DIA_HISTORIAL_LOCALES FROM
(
	...
	(
		...
		WHERE DATEPART(YEAR, A.FECHA) != 2018
