...
SELECT * FROM SJ_BI_MES_HISTORIAL_SEM_ANTERIORES_LOCALES
WHERE ANIO = $anio
...
<div style="width:100%">
  ...
  <table class="table table-striped table-fh table-9c">
	...
	<thead>
		<tr >
			<th style="width: 5%"><a href="historial_index.php?anio=<?php echo $anio?>">MES</a> /<br>SEM</th>
...
<?php
 ...
 while($v=odbc_fetch_array($result)){
	...
	<tr>
		...
		<td style="width: 5%"> 
			<a href="historial_detalle_sem_local.php?sem=<?php echo $v['SEMANA'];?>&desde=<?php echo $v['PRIMER'];?>&hasta=<?php echo $v['ULTIMO'];?>&anio=<?php echo $anio; ?>" >
			<?php echo $v['SEMANA'];?> 
			</a>
		</td>
